...
-- DROP TABLE dbo.REDFIN_MNTHLY_HOUSING_US;

CREATE TABLE REDFIN_MNTHLY_HOUSING_US (
    period_begin DATE,
    period_end DATE,
    period_duration INT,
...
-- DELETE FROM [DataMining].[dbo].[REDFIN_MNTHLY_HOUSING_US]
-- WHERE period_begin = '2025-02-01'

--SELECT COLUMN_NAME, DATA_TYPE
--FROM INFORMATION_SCHEMA.COLUMNS
--WHERE TABLE_NAME = 'REDFIN_MNTHLY_HOUSING_US';