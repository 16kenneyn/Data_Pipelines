...
class ZillowValues:
    ...
    def query_zw_data_type_lookup(self):
        # Query the lookup table for ZW Data Type
        # Columns: LOOKUP_KEY, DATA_TYPE
        data_type_lookup = pd.read_sql_query('SELECT * FROM LKP_ZW_DATA_TYPE', self.engine)
